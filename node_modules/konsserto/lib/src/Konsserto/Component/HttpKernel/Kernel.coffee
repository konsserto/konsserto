...
class Kernel
  ...
  # Class constructor
  # @param environment {String} The environment tag
  # @param debug {Boolean} The debug mode
  # @param mode {String} The application/console tag mode
  constructor: (@environment = 'dev', @debug = true, @mode = 'app') ->
    global.NODE_ENV = @environment
    global.env = @environment
    @booted = false

  # @return {String} The environment tag
  getEnvironment: () ->
    return @environment

  # @return {String} The debug mode
  getDebug: () ->
    return @debug
  ...
  # @param exitCode {Integer} The default exit status code
  ...
  # @param route {Integer} The listening port number
  start: (port) ->
