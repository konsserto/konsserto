 ...
 */
var Bundle, CONFIG, ExceptionHandler, MIDDLEWARES, MiddlewareDefinition, MiddlewareInstance, ROUTING, RouteDefinition, RouteInstance, Router, SECURITY, SOCKET, SocketDefinition, SocketInstance, bodyparser, cookieParser, csrf, express, logger, session, wait, xssFilter,
...
Router = (function() {
  ...
  Router.prototype.initSecurity = function() {
    if (SECURITY.xssProtection === void 0 || SECURITY.xssProtection === true) {
      console.log('[Security] Protection against XSS attacks explicilty OK');
