 ...
 */
var Bundle, CONFIG, ExceptionHandler, MIDDLEWARES, MiddlewareDefinition, MiddlewareInstance, ROUTING, RouteDefinition, RouteInstance, Router, SECURITY, SOCKET, SocketDefinition, SocketInstance, bodyparser, cookieParser, csrf, express, session, wait,
  ...
  Router.prototype.setHeaders = function() {
    return this.app.all('*', (function(_this) {
      return function(req, res, next) {
        ...
        if (SECURITY.ssl_protocol['headers_allowed'] != null) {
          _ref = SECURITY.ssl_protocol['headers_allowed'];
