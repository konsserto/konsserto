...
MongodbAdapter = (function() {
  ...
  MongodbAdapter.prototype.getAll = function(collectionName, callback) {
    return MongodbAdapter.CONNECTION.collection(collectionName).find({}).toArray(function(err, result) {
