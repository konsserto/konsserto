var DBCONFIG, MySql, MysqlAdapter, cc;
...
MysqlAdapter = (function() {
  ...
  MysqlAdapter.prototype.getAll = function(collectionName, callback) {
    return MysqlAdapter.CONNECTION.query('SELECT * FROM ' + collectionName, function(err, rows, fields) {
      return callback(rows);
    });
  };

  MysqlAdapter.prototype.getById = function(id, joins) {
    return {};
  };

  MysqlAdapter.prototype.getByCriteria = function(criteria, joins) {
    return [];
  };
